...
![Modelling](https://img.shields.io/badge/Modelling-blue?style=plastic)
![Simulation](https://img.shields.io/badge/Simulation-blue?style=plastic)
![Advanced-Control](https://img.shields.io/badge/Advanced--Control-blue?style=plastic)
![Matlab](https://img.shields.io/badge/Matlab-blue?style=plastic)
![Control-System-Toolbox](https://img.shields.io/badge/Control--System--Toolbox-blue?style=plastic)
...
## Control of a SE DC for ATM tramway vehicle "Carrelli 1928"
Control of the Seperate Excited DC Motor for a tramway vehicle called "Carrelli 1928"

🔗 Repository:
https://github.com/LoreB43/DC-Electic-Machine-Control

<img src="https://github.com/user-attachments/assets/447ee34f-ae31-4086-9a29-3ae1bb3accdd" width="30%" />

### 🏷️ Tags
![Matlab](https://img.shields.io/badge/Matlab-blue?style=plastic)
![Control](https://img.shields.io/badge/Control-blue?style=plastic)
![Electic-Machine](https://img.shields.io/badge/Electric--Machine-blue?style=plastic)

---

## 🏗️ FEM Analysis of an Harbour Crane
Vibration analysis using Finite Element Method on an harbour crane of different sections and materials

🔗 Repository:
https://github.com/LoreB43/Harbour-Crane

<img src="https://github.com/user-attachments/assets/9d0a3788-b06f-44c6-852d-788885169fef" width="30%"/>
<img src="https://github.com/user-attachments/assets/b95311a2-48f9-4f39-ac55-b58b3f0cce3f" width="30%"/>


### 🏷️ Tags
![FEM](https://img.shields.io/badge/FEM-blue?style=plastic)
![Mechanics](https://img.shields.io/badge/Mechanics-blue?style=plastic)

---


## Power Network System (PNS) Control
We consider a PNS composed of several power generation area coupled through tie-lines. Tie lines allow for power exchange between area. In this way, if the load profile of an area grows too much with respect to the power generated in that area neighbouring areas can contribute to satisfy the request.
The objective is to balance and control thos power exchange to satisfy energy request.

🔗 Repository:
https://github.com/LoreB43/Networked-Control

<img src="https://github.com/user-attachments/assets/bab83445-7d7e-4b8d-a18e-9fae26ece9c3" width="30%" >

### 🏷️ Tags
![Network-Control](https://img.shields.io/badge/Network--Control-blue?style=plastic)
![Energy-System](https://img.shields.io/badge/Energy--System-blue?style=plastic)
